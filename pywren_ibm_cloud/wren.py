...
class ibm_cf_executor:
    ...
    def create_timeline_plots(self, dst_dir, dst_file_name, futures=None):
        ...
        create_timeline(dst_dir, dst_file_name, self.start_time, run_statuses, invoke_statuses, self.config[backend])
        create_histogram(dst_dir, dst_file_name, self.start_time, run_statuses, self.config[backend])
